...
const Info: React.FC = () => {
  const [showPopup, setShowPopup] = React.useState<null | '1.0' | '2.0' | '2.1'>(null);
  return (
        ...
        <section className="mb-6">
          ...
          {showPopup === '2.0' && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
              <div className="bg-surface rounded-lg shadow-lg p-6 max-w-md w-full text-text relative">
                <button className="absolute top-2 right-2 text-xl font-bold" onClick={() => setShowPopup(null)}>&times;</button>
                <h3 className="text-xl font-bold mb-2">2.0 : 08/2025 - 10/2025 </h3>
                <ul className="list-disc ml-6">
          ...
          {showPopup === '2.1' && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
              <div className="bg-surface rounded-lg shadow-lg p-6 max-w-md w-full text-text relative">
                <button className="absolute top-2 right-2 text-xl font-bold" onClick={() => setShowPopup(null)}>&times;</button>
                <h3 className="text-xl font-bold mb-2">2.1 : 11/2025 - Present </h3>
                <ul className="list-disc ml-6">
